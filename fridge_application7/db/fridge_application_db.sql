...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 05, 2025 at 12:39 PM
...
(3, 'Kambata8', 'Sleepysheep8@gmail.com', '$2y$10$6rtZBNElXFQ6QnDfpSBp/.xuWzuez/G.is6whphMlIlhBD7VzQzIy', 'premium', 'vegetarian'),
...
(7, 3, 11, 'units', 5.00, '2025-03-06', 'from Billa', '2025-02-22'),
(17, 4, 2, 'kg', 45.00, '6789-03-03', '', '2025-02-22'),
(18, 4, 7, 'g', 12.00, '2025-02-13', '', '2025-02-22'),
(19, 3, 3, 'kg', 2.00, '2025-03-06', 'store bought', '2025-02-27'),
(21, 5, 8, 'units', 3.00, '2025-03-05', '', '2025-02-27'),
(22, 5, 2, 'units', 3.00, '2025-03-07', '', '2025-02-27'),
(23, 5, 6, 'units', 2.00, '2025-03-05', '', '2025-02-27'),
(24, 3, 7, 'kg', 1.00, '2025-03-05', '', '2025-02-28'),
(25, 3, 7, 'kg', 1.00, '2025-03-05', '', '2025-02-28'),
(26, 3, 9, 'kg', 88.00, '2025-02-11', '', '2025-02-28'),
...
ALTER TABLE `user_meal_plan`
  ...
  ADD UNIQUE KEY `user_id` (`user_id`,`plan_date`),
  ADD KEY `fk_lunch_recipe` (`lunch_recipe_id`),
  ADD KEY `fk_dinner_recipe` (`dinner_recipe_id`);
...
--
ALTER TABLE `user_shopping_list`
  MODIFY `shopping_list_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
...
--
-- Constraints for table `user_meal_plan`
--
ALTER TABLE `user_meal_plan`
  ADD CONSTRAINT `fk_dinner_recipe` FOREIGN KEY (`dinner_recipe_id`) REFERENCES `recipes` (`recipe_id`) ON DELETE SET NULL,
  ADD CONSTRAINT `fk_lunch_recipe` FOREIGN KEY (`lunch_recipe_id`) REFERENCES `recipes` (`recipe_id`) ON DELETE SET NULL,
  ADD CONSTRAINT `fk_user_meal_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE;
