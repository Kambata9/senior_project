...
--
-- Host: localhost
-- Generation Time: Mar 22, 2025 at 10:23 AM
...
(99, 'Kambata99', 'Sleepysheep99@gmail.com', '$2y$10$NjpappdQ4CTbHmvc9BhD6urJtKA.Bk.nLLYlYwJ0zvBiTuROT7Dam', 'admin', NULL),
(10017, 'Kambata1', 'Sleepysheep1@gmail.com', '$2y$10$zd7RraSbiafGD6ZIqVpCRephevou0oGxOQs6KdKiIQ.9zdjTAMoy6', 'premium', 'vegan');
...
(120, 10017, 11, NULL, NULL, '2025-03-29', '', '2025-03-22'),
(121, 10017, 21, NULL, NULL, '2025-03-26', '', '2025-03-22'),
(122, 10017, 14, NULL, NULL, '2025-03-27', '', '2025-03-22');
...
INSERT INTO `user_security` (`user_id`, `security_question`, `security_answer`) VALUES
(10017, 'In what city were you born?', '$2y$10$APhSlPaCC0gj3ebfVECU9OIbcFy.rKd/c.PaIoMG.r5LAlygESTkG');
...
(186, 8, 10017, '2025-03-22 10:20:21');
...
--
ALTER TABLE `user_shopping_list`
  MODIFY `shopping_list_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=187;
...
--
ALTER TABLE `user_security`
  ADD CONSTRAINT `fk_user_security_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
