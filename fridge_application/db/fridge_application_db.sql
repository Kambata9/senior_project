...
(10023, 'Kambata3', 'Sleepysheep3@gmail.com', '$2y$10$oDUttKrwFBXxHoGrnAj1/uKhOcUb3taIfyfq5fCZ5t9/n1hL3pNJ6', 'premium', 'vegan');
...
(123, 10023, 21, NULL, NULL, '2025-03-29', '', '2025-03-26'),
(124, 10023, 14, NULL, NULL, '2025-04-02', '', '2025-03-26');
...
(10023, 2, '$2y$10$.MIKAZJYI95RJCRFSNKtbu1amSYK/CQN4rMl25Y/6Z4qFIXbBCnHy');
...
(187, 15, 10023, '2025-03-26 08:12:09'),
(188, 16, 10023, '2025-03-26 08:12:09'),
(189, 17, 10023, '2025-03-26 08:12:09');
...
--
ALTER TABLE `ingredients`
  MODIFY `ingredient_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=132;
...
--
ALTER TABLE `users`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10025;

--
-- AUTO_INCREMENT for table `user_inventory`
--
ALTER TABLE `user_inventory`
  MODIFY `inventory_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;

--
-- AUTO_INCREMENT for table `user_shopping_list`
--
ALTER TABLE `user_shopping_list`
  MODIFY `shopping_list_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=190;
